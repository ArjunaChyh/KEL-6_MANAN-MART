...
<body>
        ...
        <div class="products-container">
            ...
            <div class="products-grid">
                <div class="product-card">
                    <img src="images/Minyak.png" alt="Garam Cap Udang" class="product-image">
                    <h3 class="product-name">Minyak</h3>
    ...
    <script>
        ...
        const suggestions = ["Minyak Goreng", "Tepung Terigu", "Gula Pasir", "Garam", "Beras", "Mie"];
        ...
        popularItems.forEach(item => {
            item.addEventListener('click', () => {
                ...
                if (img) {
                    ...
                    alert(`Viewing popular item: ${altText}`);
                }
            });
        });
    </script>
