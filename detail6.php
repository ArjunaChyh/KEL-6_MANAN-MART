...
<body>
    ...
    <div class="weight">250gr</div>
    </div>
    <div class="popup-right">
        <button type="button" class="popup-description-btn">Deskripsi</button>
        <p class="popup-description-text">
            Memiliki kandungan yodium dan bisa digunakan untuk memasak/ditaburkanpada makanan agarmenambah cita rasa.
        </p>
