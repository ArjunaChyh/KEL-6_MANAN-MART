...
<body>
    ...
    <img
        ...
        width="120"
        height="120" />
    <div class="price">Rp.74.000,00</div>
    <div class="name">Beras Ramos</div>
    ...
    <div class="popup-right">
        ...
        <p class="popup-description-text">
            Hasil olahan dari biji-bijian padi (Oryza sativa), yang telah melalui proses pengupasan dan penggilingan kulit gabah
        </p>
