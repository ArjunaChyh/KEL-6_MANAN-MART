...
<body>
    <header class="header">
        ...
        <div class="search-container">
            <input type="text" class="search-bar" id="search-bar" placeholder="Cari Di MANAN MART" />
            <button class="search-button">
                <img src="images/Search.svg" alt="Search" width="23" height="25" />
            </button>
            <ul class="dropdown" id="dropdown">
                <li><a href="keranjang3.php">Minyak Goreng</a></li>
                <li><a href="keranjang4.php">Tepung Terigu</a></li>
                <li><a href="keranjang5.php">Gula Pasir</a></li>
                <li><a href="keranjang1.php">Garam</a></li>
                <li><a href="keranjang6.php">Beras</a></li>
                <li><a href="keranjang2.php">Mie</a></li>
            </ul>
        </div>
        ...
        <div class="book-icon" title="Pesanan">
            <a href="riwayat.php">
    ...
    <main class="main-content">
        ...
        <a href="detail2.php">
            <div class="popular-item">
                <img src="images/Minyak.png" alt="Minyak Kita" class="popular-image" />
            </div>
        </a>

        <a href="detail4.php">
            <div class="popular-item">
                <img src="images/miedara.png" alt="Mi Burung Dara" class="popular-image" />
            </div>
        </a>
