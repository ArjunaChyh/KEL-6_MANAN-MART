    ...
    <main class="main-content">
        ...
        <div class="products-container">
            ...
            <div class="products-grid">
                ...
                <div class="product-card">
                    <img src="iages/Minyak.png" alt="Minyak Kita" class="product-image" />
    ...
    <div class="popup-container" role="dialog" aria-modal="true" aria-labelledby="popup-title">
        ...
        <div class="popup-left">
            <img
                ...
                height="120"
            />
            <div class="price">Rp.5.500,00</div>
            <div class="name">Garam Cap Udang</div>
            <div class="weight">250 gr</div>
        </div>
        <div class="popup-right">
            <button type="button" class="popup-description-btn">Deskripsi</button>
            <p class="popup-description-text">
                Senyawa organik yang termasuk golongan karbohidrat, dikenal karena rasanya yang manis dan mudah larut dalam air
            </p>
